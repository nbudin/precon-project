...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'precon_change', (
            ...
            ('time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 25, 0, 0))),
    ...
    models = {
        u'precon.change': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 25, 0, 0)'})
        },
        u'precon.day': {
        ...
        u'precon.participant': {
            ...
            'nonce': ('django.db.models.fields.CharField', [], {'default': "'8j31bh'", 'unique': 'True', 'max_length': '6'}),
