...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.max_panels'
        db.add_column(u'precon_participant', 'max_panels',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=10),
                      keep_default=False)

        # Adding field 'PanelProposal.suggested_by'
        db.add_column(u'precon_panelproposal', 'suggested_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='panelproposals_suggested', null=True, to=orm['precon.Panelist']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.max_panels'
        db.delete_column(u'precon_participant', 'max_panels')

        # Deleting field 'PanelProposal.suggested_by'
        db.delete_column(u'precon_panelproposal', 'suggested_by_id')
    ...
    models = {
        ...
        u'precon.participant': {
            ...
            'nonce': ('django.db.models.fields.CharField', [], {'default': "'6uuxi9'", 'unique': 'True', 'max_length': '6'}),
