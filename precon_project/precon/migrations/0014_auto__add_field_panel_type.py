...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Panel.type'
        db.add_column(u'precon_panel', 'type',
                      self.gf('django.db.models.fields.CharField')(default='Panel', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Panel.type'
        db.delete_column(u'precon_panel', 'type')
    ...
    models = {
        ...
        u'precon.participant': {
            ...
            'nonce': ('django.db.models.fields.CharField', [], {'default': "'a9qn4g'", 'unique': 'True', 'max_length': '6'}),
