...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PanelProposalResponse.comments'
        db.delete_column(u'precon_panelproposalresponse', 'comments')

        # Adding field 'PanelProposalResponse.presenting_comments'
        db.add_column(u'precon_panelproposalresponse', 'presenting_comments',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Adding field 'PanelProposalResponse.attending_comments'
        db.add_column(u'precon_panelproposalresponse', 'attending_comments',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=1000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PanelProposalResponse.comments'
        db.add_column(u'precon_panelproposalresponse', 'comments',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Deleting field 'PanelProposalResponse.presenting_comments'
        db.delete_column(u'precon_panelproposalresponse', 'presenting_comments')

        # Deleting field 'PanelProposalResponse.attending_comments'
        db.delete_column(u'precon_panelproposalresponse', 'attending_comments')
    ...
    models = {
        ...
        u'precon.participant': {
            ...
            'modification_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'nonce': ('django.db.models.fields.CharField', [], {'default': "'t11094'", 'unique': 'True', 'max_length': '6'}),
