...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Panel.needs_projector'
        db.add_column(u'precon_panel', 'needs_projector',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Panel.needs_projector'
        db.delete_column(u'precon_panel', 'needs_projector')
    ...
    models = {
        ...
        u'precon.participant': {
            ...
            'nonce': ('django.db.models.fields.CharField', [], {'default': "'e9aie3'", 'unique': 'True', 'max_length': '6'}),
