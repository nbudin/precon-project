...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Panel.length'
        db.delete_column(u'precon_panel', 'length')

        # Adding M2M table for field _slot_m2m on 'Panel'
        m2m_table_name = db.shorten_name(u'precon_panel__slot_m2m')
    ...
    def backwards(self, orm):
        # Adding field 'Panel.length'
        db.add_column(u'precon_panel', 'length',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=10),
                      keep_default=False)

        # Removing M2M table for field _slot_m2m on 'Panel'
        db.delete_table(db.shorten_name(u'precon_panel__slot_m2m'))
    ...
    models = {
        ...
        u'precon.panel': {
            ...
            '_slot_m2m': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['precon.Slot']", 'null': 'True', 'blank': 'True'}),
        ...
        u'precon.participant': {
            ...
            'nonce': ('django.db.models.fields.CharField', [], {'default': "'mo5p8i'", 'unique': 'True', 'max_length': '6'}),
