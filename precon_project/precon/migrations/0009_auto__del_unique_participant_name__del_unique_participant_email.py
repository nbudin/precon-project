...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'precon_participant', ['email'])

        # Removing unique constraint on 'Participant', fields ['name']
        db.delete_unique(u'precon_participant', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Participant', fields ['name']
        db.create_unique(u'precon_participant', ['name'])

        # Adding unique constraint on 'Participant', fields ['email']
        db.create_unique(u'precon_participant', ['email'])
    ...
    models = {
        ...
        u'precon.participant': {
            ...
            'nonce': ('django.db.models.fields.CharField', [], {'default': "'68mzn7'", 'unique': 'True', 'max_length': '6'}),
