...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'precon_panel', 'slot',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='panels', null=True, to=orm['precon.Slot'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'precon.participant': {
            ...
            'nonce': ('django.db.models.fields.CharField', [], {'default': "'jfvcw4'", 'unique': 'True', 'max_length': '6'}),
