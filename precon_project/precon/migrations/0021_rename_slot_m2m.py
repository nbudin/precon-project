...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('precon_panel__slot_m2m', 'precon_panel_slot')

    def backwards(self, orm):
        db.rename_table('precon_panel_slot', 'precon_panel__slot_m2m')
    ...
    models = {
        ...
        u'precon.participant': {
            ...
            'nonce': ('django.db.models.fields.CharField', [], {'default': "'fayj8n'", 'unique': 'True', 'max_length': '6'}),
