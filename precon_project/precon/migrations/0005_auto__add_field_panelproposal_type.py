...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PanelProposal.type'
        db.add_column(u'precon_panelproposal', 'type',
                      self.gf('django.db.models.fields.CharField')(default='Panel', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PanelProposal.type'
        db.delete_column(u'precon_panelproposal', 'type')
    ...
    models = {
        ...
        u'precon.participant': {
            ...
            'modification_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'nonce': ('django.db.models.fields.CharField', [], {'default': "'hjqioi'", 'unique': 'True', 'max_length': '6'}),
