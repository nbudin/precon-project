...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Panel.panel_proposal'
        db.add_column(u'precon_panel', 'panel_proposal',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='panels_accepted', null=True, to=orm['precon.PanelProposal']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Panel.panel_proposal'
        db.delete_column(u'precon_panel', 'panel_proposal_id')
    ...
    models = {
        ...
        u'precon.participant': {
            ...
            'nonce': ('django.db.models.fields.CharField', [], {'default': "'fsi95a'", 'unique': 'True', 'max_length': '6'}),
