...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Change.time'
        db.delete_column(u'precon_change', 'time')


    def backwards(self, orm):
        # Adding field 'Change.time'
        db.add_column(u'precon_change', 'time',
    ...
    models = {
        ...
        u'precon.participant': {
            ...
            'nonce': ('django.db.models.fields.CharField', [], {'default': "'reknx7'", 'unique': 'True', 'max_length': '6'}),
