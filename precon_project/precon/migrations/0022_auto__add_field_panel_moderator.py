...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Panel.moderator'
        db.add_column(u'precon_panel', 'moderator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='panels_moderating', null=True, to=orm['precon.Panelist']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Panel.moderator'
        db.delete_column(u'precon_panel', 'moderator_id')
    ...
    models = {
        ...
        u'precon.participant': {
            ...
            'nonce': ('django.db.models.fields.CharField', [], {'default': "'ou1sdu'", 'unique': 'True', 'max_length': '6'}),
